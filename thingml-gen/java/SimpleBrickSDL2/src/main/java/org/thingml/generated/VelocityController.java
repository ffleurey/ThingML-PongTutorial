...
public VelocityController(final int VelocityController_timerID_var, final int TimerController_XMIN_var, final int TimerController_YMIN_var, final int TimerController_XMAX_var, final int TimerController_YMAX_var) {
super();
...
public VelocityController(String name, final int VelocityController_timerID_var, final int TimerController_XMIN_var, final int TimerController_YMIN_var, final int TimerController_posX_var, final int TimerController_posY_var, final int TimerController_XMAX_var, final int TimerController_dx_var, final int TimerController_dy_var, final int TimerController_YMAX_var) {
super(name);
this.VelocityController_timerID_var = VelocityController_timerID_var;
this.TimerController_XMIN_var = TimerController_XMIN_var;
this.TimerController_YMIN_var = TimerController_YMIN_var;
...
transitions_VelocityController_SC.add(new Transition("433466536",timer_timeoutType, clock_port, state_VelocityController_SC_Running, state_VelocityController_SC_Running){
@Override
