...
public Java2DDisplay(String name, final int Java2DDisplay_YFRAMESIZE_var, final int Java2DDisplay_SCALE_var, final int Java2DDisplay_XFRAMESIZE_var) {
super(name);
...
transitions_Display_SC.add(new Transition("1340047203",createType, display_port, state_Display_SC_Wait, state_Display_SC_Running){
@Override
...
transitions_Display_SC.add(new InternalTransition("1685175066",setColorType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("1891521863",clearType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
clearScreen();
}
...
transitions_Display_SC.add(new InternalTransition("1950835269",drawRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("353880274",fillRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("1734540787",updateType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
updateDisplay();
}
...
transitions_Display_SC.add(new Transition("908411651",destroyType, display_port, state_Display_SC_Running, state_Display_SC_Destroyed){
@Override
public void doExecute(final Event e) {
destroyDisplay();
}
...
g2d.drawRect(Java2DDisplay_drawRect_x_var,Java2DDisplay_drawRect_y_var,Java2DDisplay_drawRect_width_var,Java2DDisplay_drawRect_height_var);
}
