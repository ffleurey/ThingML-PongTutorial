...
public Java2DDisplay(String name, final int Java2DDisplay_YFRAMESIZE_var, final int Java2DDisplay_SCALE_var, final int Display_bg_b_var, final int Display_bg_r_var, final int Display_fg_g_var, final int Display_fg_r_var, final int Java2DDisplay_XFRAMESIZE_var, final int Display_bg_g_var, final int Display_fg_b_var) {
super(name);
...
transitions_Display_SC.add(new Transition("191320122",createType, display_port, state_Display_SC_Wait, state_Display_SC_Running){
@Override
...
transitions_Display_SC.add(new InternalTransition("1144334904",setColorType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("911063249",setBGColorType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("2075050977",clearType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
clearScreen();
}
...
transitions_Display_SC.add(new InternalTransition("1158483369",drawRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("166206843",fillRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("164420916",updateType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
updateDisplay();
}
...
transitions_Display_SC.add(new InternalTransition("451198452",drawIntegerType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new Transition("1231100497",destroyType, display_port, state_Display_SC_Running, state_Display_SC_Destroyed){
@Override
public void doExecute(final Event e) {
destroyDisplay();
}
