...
transitions_Display_SC.add(new Transition("192789446",createType, display_port, state_Display_SC_Wait, state_Display_SC_Running){
@Override
...
transitions_Display_SC.add(new InternalTransition("1455493702",setColorType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("1106657876",clearType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
clearScreen();
}
...
transitions_Display_SC.add(new InternalTransition("403445011",drawRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("1549484551",fillRectType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
...
transitions_Display_SC.add(new InternalTransition("1929717288",updateType, display_port, state_Display_SC_Running){
@Override
public void doExecute(final Event e) {
updateDisplay();
}
...
transitions_Display_SC.add(new Transition("1231642329",destroyType, display_port, state_Display_SC_Running, state_Display_SC_Destroyed){
@Override
public void doExecute(final Event e) {
destroyDisplay();
}
