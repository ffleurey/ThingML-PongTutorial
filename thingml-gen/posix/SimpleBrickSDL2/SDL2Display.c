...
void SDL2Display_send_controls_fire(struct SDL2Display_Instance *_instance);
//Prototypes: Function
...
void (*external_SDL2Display_send_controls_fire_listener)(struct SDL2Display_Instance *)= 0x0;
void (*SDL2Display_send_controls_fire_listener)(struct SDL2Display_Instance *)= 0x0;
void register_external_SDL2Display_send_controls_fire_listener(void (*_listener)(struct SDL2Display_Instance *)){
external_SDL2Display_send_controls_fire_listener = _listener;
}
void register_SDL2Display_send_controls_fire_listener(void (*_listener)(struct SDL2Display_Instance *)){
SDL2Display_send_controls_fire_listener = _listener;
}
void SDL2Display_send_controls_fire(struct SDL2Display_Instance *_instance){
if (SDL2Display_send_controls_fire_listener != 0x0) SDL2Display_send_controls_fire_listener(_instance);
if (external_SDL2Display_send_controls_fire_listener != 0x0) external_SDL2Display_send_controls_fire_listener(_instance);
;
}
