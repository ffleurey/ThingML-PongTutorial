...
SimpleBrick_send_display_setColor(_instance, 0, 0, 0);
...
SimpleBrick_send_display_setColor(_instance, 100, 100, 100);
...
SimpleBrick_send_display_setColor(_instance, 200, 200, 200);
...
if(collision) {
_instance->SimpleBrick_dy_var =  -_instance->SimpleBrick_dy_var;
_instance->SimpleBrick_SC_score_var = _instance->SimpleBrick_SC_score_var + 1;
SimpleBrick_send_display_setColor(_instance, 255, 255, 255);
SimpleBrick_send_display_drawInteger(_instance, 100, 1, _instance->SimpleBrick_SC_score_var, 5, 2);
...
SimpleBrick_send_display_setBGColor(_instance, 0, 0, 0);
SimpleBrick_send_display_drawInteger(_instance, 100, 1, _instance->SimpleBrick_SC_score_var, 5, 2);
