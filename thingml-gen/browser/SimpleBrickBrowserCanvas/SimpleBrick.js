 ...
 **/
function SimpleBrick(name, root, SimpleBrick_YMAX_var, SimpleBrick_lives_var, SimpleBrick_pady_var, SimpleBrick_prevBX_var, SimpleBrick_BRICK_HEIGHT_var, SimpleBrick_bricks_var, SimpleBrick_SCALE_var, SimpleBrick_dx_var, SimpleBrick_score_var, SimpleBrick_TOP_var, SimpleBrick_padlen_var, SimpleBrick_level_var, SimpleBrick_BRICK_ROWS_var, SimpleBrick_by_var, SimpleBrick_prevBY_var, SimpleBrick_prevPX_var, SimpleBrick_XMAX_var, SimpleBrick_br_var, SimpleBrick_XDISPSIZE_var, SimpleBrick_fgcolor_var, SimpleBrick_LEFT_var, SimpleBrick_bgcolor_var, SimpleBrick_YDISPSIZE_var, SimpleBrick_RIGHT_var, SimpleBrick_dy_var, SimpleBrick_padx_var, SimpleBrick_BOTTOM_var, SimpleBrick_bx_var, SimpleBrick_prevPY_var, debug) {
...
this.drawBall();
this.drawPad();
this.bus.emit('ia?updateIA', this.SimpleBrick_bx_var, this.SimpleBrick_by_var, this.SimpleBrick_padx_var, this.SimpleBrick_pady_var);
this.bus.emit('display?update');
this.bus.emit('clock?timer_start', 0, 33);
});
