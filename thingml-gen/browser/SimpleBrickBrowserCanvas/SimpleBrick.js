 ...
 **/
function SimpleBrick(name, root, SimpleBrick_LEFT_var, SimpleBrick_score_var, SimpleBrick_prevPY_var, SimpleBrick_BRICK_HEIGHT_var, SimpleBrick_padx_var, SimpleBrick_by_var, SimpleBrick_TOP_var, SimpleBrick_fgcolor_var, SimpleBrick_BOTTOM_var, SimpleBrick_bx_var, SimpleBrick_dy_var, SimpleBrick_RIGHT_var, SimpleBrick_br_var, SimpleBrick_YDISPSIZE_var, SimpleBrick_prevBY_var, SimpleBrick_bgcolor_var, SimpleBrick_SCALE_var, SimpleBrick_padlen_var, SimpleBrick_prevPX_var, SimpleBrick_dx_var, SimpleBrick_lives_var, SimpleBrick_level_var, SimpleBrick_pady_var, SimpleBrick_BRICK_ROWS_var, SimpleBrick_XDISPSIZE_var, SimpleBrick_bricks_var, SimpleBrick_XMAX_var, SimpleBrick_YMAX_var, SimpleBrick_prevBX_var, debug) {
...
setTimeout(() => this.bus.emit('clock?timer_start', 0, 33), 0);
this.drawPad();
this.drawCountDown(Math.floor(this.SimpleBrick_SC_LAUNCH_countdown_var / 30) + 1);
...
if(this.SimpleBrick_bx_var > this.SimpleBrick_padx_var - Math.floor(this.SimpleBrick_padlen_var / 2) && this.SimpleBrick_bx_var < this.SimpleBrick_padx_var + Math.floor(this.SimpleBrick_padlen_var / 2)) {
this.SimpleBrick_dy_var =  -this.SimpleBrick_dy_var;
this.bus.emit('dy=', this.SimpleBrick_dy_var);
this.SimpleBrick_by_var = 2 * (this.SimpleBrick_pady_var - this.SimpleBrick_br_var) - this.SimpleBrick_by_var;
this.bus.emit('by=', this.SimpleBrick_by_var);
this.SimpleBrick_dx_var = Math.floor(this.SimpleBrick_dx_var / 4) + Math.floor((this.SimpleBrick_bx_var - this.SimpleBrick_padx_var) / 4);
this.bus.emit('dx=', this.SimpleBrick_dx_var);
...
this.drawBall();
this.drawPad();
setTimeout(() => this.bus.emit('ia?updateIA', this.SimpleBrick_bx_var, this.SimpleBrick_by_var, this.SimpleBrick_padx_var, this.SimpleBrick_pady_var), 0);
this.bus.emit('display?update');
setTimeout(() => this.bus.emit('clock?timer_start', 0, 33), 0);
});
...
this.SimpleBrick_padx_var = this.SimpleBrick_LEFT_var + center_var + Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 2);
...
this.SimpleBrick_bx_var = this.SimpleBrick_padx_var - Math.floor(this.SimpleBrick_br_var / this.SimpleBrick_SCALE_var);
this.bus.emit('bx=', this.SimpleBrick_bx_var);
this.SimpleBrick_by_var = this.SimpleBrick_pady_var - Math.floor(this.SimpleBrick_br_var / this.SimpleBrick_SCALE_var);
this.bus.emit('by=', this.SimpleBrick_by_var);
this.SimpleBrick_dx_var = Math.floor(this.SimpleBrick_XMAX_var / 98);
this.bus.emit('dx=', this.SimpleBrick_dx_var);
this.SimpleBrick_dy_var = Math.floor( -this.SimpleBrick_XMAX_var / 65);
this.bus.emit('dy=', this.SimpleBrick_dy_var);
};

SimpleBrick.prototype.eraseBall = function() {
let bs_var = Math.floor((this.SimpleBrick_br_var * 2) / this.SimpleBrick_SCALE_var);
...
let bs_var = Math.floor((this.SimpleBrick_br_var * 2) / this.SimpleBrick_SCALE_var);
this.eraseBall();
this.SimpleBrick_prevBX_var = Math.floor((this.SimpleBrick_bx_var - this.SimpleBrick_br_var) / this.SimpleBrick_SCALE_var);
this.bus.emit('prevBX=', this.SimpleBrick_prevBX_var);
this.SimpleBrick_prevBY_var = Math.floor((this.SimpleBrick_by_var - this.SimpleBrick_br_var) / this.SimpleBrick_SCALE_var);
...
let ps_var = Math.floor(this.SimpleBrick_padlen_var / this.SimpleBrick_SCALE_var);
...
let ps_var = Math.floor(this.SimpleBrick_padlen_var / this.SimpleBrick_SCALE_var);
this.erasePad();
this.SimpleBrick_prevPX_var = Math.floor((this.SimpleBrick_padx_var - (Math.floor(this.SimpleBrick_padlen_var / 2))) / this.SimpleBrick_SCALE_var);
this.bus.emit('prevPX=', this.SimpleBrick_prevPX_var);
this.SimpleBrick_prevPY_var = Math.floor(this.SimpleBrick_pady_var / this.SimpleBrick_SCALE_var);
...
this.bus.emit('display?fillRect', Math.floor(this.SimpleBrick_LEFT_var / this.SimpleBrick_SCALE_var) - 1, Math.floor(this.SimpleBrick_TOP_var / this.SimpleBrick_SCALE_var) - 1, Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / this.SimpleBrick_SCALE_var) + 1, 1);
this.bus.emit('display?fillRect', Math.floor(this.SimpleBrick_LEFT_var / this.SimpleBrick_SCALE_var) - 1, Math.floor(this.SimpleBrick_BOTTOM_var / this.SimpleBrick_SCALE_var) - 1, Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / this.SimpleBrick_SCALE_var) + 1, 1);
this.bus.emit('display?fillRect', Math.floor(this.SimpleBrick_LEFT_var / this.SimpleBrick_SCALE_var) - 1, Math.floor(this.SimpleBrick_TOP_var / this.SimpleBrick_SCALE_var), 1, Math.floor((this.SimpleBrick_BOTTOM_var - this.SimpleBrick_TOP_var) / this.SimpleBrick_SCALE_var));
this.bus.emit('display?fillRect', Math.floor(this.SimpleBrick_RIGHT_var / this.SimpleBrick_SCALE_var) - 1, Math.floor(this.SimpleBrick_TOP_var / this.SimpleBrick_SCALE_var), 1, Math.floor((this.SimpleBrick_BOTTOM_var - this.SimpleBrick_TOP_var) / this.SimpleBrick_SCALE_var));
};
...
let bx_var = this.SimpleBrick_LEFT_var + (Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 8)) * SimpleBrick_drawBrick_x_var;
...
this.bus.emit('display?fillRect', Math.floor(bx_var / this.SimpleBrick_SCALE_var) + 1, Math.floor(by_var / this.SimpleBrick_SCALE_var) + 1, Math.floor((Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 8)) / this.SimpleBrick_SCALE_var) - 2, this.SimpleBrick_BRICK_HEIGHT_var - 2);
this.bus.emit('display?setColor', 100, 56, 43);
this.bus.emit('display?drawRect', Math.floor(bx_var / this.SimpleBrick_SCALE_var) + 1, Math.floor(by_var / this.SimpleBrick_SCALE_var) + 1, Math.floor((Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 8)) / this.SimpleBrick_SCALE_var) - 2, this.SimpleBrick_BRICK_HEIGHT_var - 2);
};

SimpleBrick.prototype.removeBrick = function(SimpleBrick_removeBrick_x_var, SimpleBrick_removeBrick_y_var) {
let bx_var = this.SimpleBrick_LEFT_var + (Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 8)) * SimpleBrick_removeBrick_x_var;
...
let bry_var = Math.floor((SimpleBrick_collideBrick_ypos_var - this.SimpleBrick_TOP_var - 20 * this.SimpleBrick_SCALE_var) / (this.SimpleBrick_BRICK_HEIGHT_var * this.SimpleBrick_SCALE_var));
let result_var = false;
if(bry_var >= 0 && bry_var < this.SimpleBrick_BRICK_ROWS_var) {
let brx_var = Math.floor((SimpleBrick_collideBrick_xpos_var - this.SimpleBrick_LEFT_var) / (Math.floor((this.SimpleBrick_RIGHT_var - this.SimpleBrick_LEFT_var) / 8)));
