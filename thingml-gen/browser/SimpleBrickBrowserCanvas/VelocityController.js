 ...
 **/
function VelocityController(name, root, TimerController_YMAX_var, TimerController_XMIN_var, VelocityController_timerID_var, TimerController_dy_var, TimerController_posX_var, TimerController_posY_var, TimerController_XMAX_var, TimerController_YMIN_var, TimerController_dx_var, debug) {
...
VelocityController_SC_Running.to(null).when((position) => {return position._port === 'ctrl_in' && position._msg === 'position';}).effect((position) => {
