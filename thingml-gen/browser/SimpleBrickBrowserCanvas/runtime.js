...
var ctrl_XMIN =  -100;
/*$CONFIGURATION ctrl$*/
const ctrl = new VelocityController('ctrl', null, ctrl_dy, ctrl_YMAX, ctrl_posY, ctrl_dx, ctrl_posX, ctrl_YMIN, ctrl_XMAX, ctrl_timerID, ctrl_XMIN, false);
var timer_Timeouts = {};
/*$CONFIGURATION timer$*/
...
var bb_prevPY =  -1;
/*$CONFIGURATION bb$*/
const bb = new SimpleBrick('bb', null, bb_YMAX, bb_lives, bb_pady, bb_prevBX, bb_BRICK_HEIGHT, bb_bricks, bb_SCALE, bb_dx, bb_score, bb_TOP, bb_padlen, bb_level, bb_BRICK_ROWS, bb_by, bb_prevBY, bb_prevPX, bb_XMAX, bb_br, bb_XDISPSIZE, bb_fgcolor, bb_LEFT, bb_bgcolor, bb_YDISPSIZE, bb_RIGHT, bb_dy, bb_padx, bb_BOTTOM, bb_bx, bb_prevPY, false);
...
/*$CONFIGURATION disp$*/
const disp = new BrowserCanvasDisplay('disp', null, disp_XFRAMESIZE, disp_YFRAMESIZE, disp_BufferCanvas, disp_SCALE, disp_Buffer, disp_Display, false);
/*$PLUGINS$*/
